...
# ==========================================
# 🌌 THE NEXUS CONFIGURATION / إعدادات النيكسوس
# ==========================================
# 1) PASTE YOUR BOT TOKEN HERE / ضع توكن البوت الخاص بك هنا:
# If you cannot set environment variables in your panel, paste your Discord Bot Token below:
MY_BOT_TOKEN = "your_bot_token_here"

# 2) AUTOMATIC COMMAND SYNC / التفعيل التلقائي لمزامنة الأوامر:
# We enable global sync by default so your commands register globally in all servers automatically.
os.environ["ENABLE_GLOBAL_COMMAND_SYNC"] = "true"
# ==========================================
